...
const Dashboard = () => {
    ...
    const list_Data = {
        ...
        "point1": "Simplified Analytics: See all your key performance indicators in a snap! Understand your business better and fix any bottlenecks for increased profitability.",
        "point2": "Focus on What Matters: Identify areas that need attention and invest your efforts wisely for maximum impact.",
        "point3": "Accurate Forecasts: Plan room occupancy, revenue, and distribution with precision, thanks to exact numbers and trends."

    }

    const list_Data2 = {
        "heading": "How It Works:",
        "point1": "Room Reservations: Keep track of all reservations effortlessly.See new guests, checkouts, and reservation statuses at a glance.",
        "point2": "Guest Insights: Get to know your guests inside out.Measure customer engagement, preferences, and spending habits for targeted marketing.",
        "point3": "Stay Alert: Stay on top of guest arrivals, departures, and in -house bookings for smooth operations.",
        "point4": "Source Tracking: Know where your bookings come from - direct, OTA systems, or Channel Manager - to optimize your marketing efforts.",

    }

    const list_Data3 = {
        "heading": "What You Get:",
        "point1": "Clear Data Clarity: Real - time KPIs and easy - to - understand numbers for quick decision - making.",
        "point2": "Gainers and Losers: Compare different indicators side by side to spot top performers.",
        "point3": "New Creative Solutions: Unleash your creativity with data presented in various forms.",
    }

    const list_Data4 = {
        "heading": "What Makes Eazotel Dashboard Special:",
        "point1": "Unity of Components: Graphics, diagrams, and numbers come together to form a cohesive picture.",
        "point2": "Data Hierarchy: Information is systematically displayed, allowing for easy comparison and analysis.",
        "point3": "Simplicity and Live Updates: Complicated information made simple, with new indicators added in a jiffy.",
    }
